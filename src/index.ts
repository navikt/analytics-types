...
export * from './events/aksel/accordion/apnet.js';
export * from './events/aksel/accordion/lukket.js';
export * from './events/aksel/actionmenu/apnet.js';
export * from './events/aksel/actionmenu/lukket.js';
export * from './events/aksel/actionmenu/valg-valgt.js';
export * from './events/aksel/actionmenu/undermeny-apnet.js';
export * from './events/aksel/actionmenu/undermeny-lukket.js';
export * from './events/aksel/actionmenu/types.js';
export * from './events/aksel/alert/lukket.js';
export * from './events/aksel/alert/vist.js';
export * from './events/aksel/globalalert/vist.js';
export * from './events/aksel/globalalert/lukket.js';
export * from './events/aksel/localalert/vist.js';
export * from './events/aksel/localalert/lukket.js';
export * from './events/aksel/inlinemessage/vist.js';
export * from './events/aksel/infocard/vist.js';
export * from './events/aksel/process/vist.js';
export * from './events/aksel/process/steg-klikket.js';
export * from './events/aksel/checkbox/endret.js';
export * from './events/besok/besok.js';
export * from './events/aksel/chips/fjernet.js';
export * from './events/aksel/chips/toggled.js';
export * from './events/aksel/combobox/option-toggled.js';
export * from './events/aksel/datepicker/dato-valgt.js';
export * from './events/aksel/errorsummary/vist.js';
export * from './events/aksel/errorsummary/feilmelding-klikket.js';
export * from './events/aksel/tabs/fane-byttet.js';
export * from './events/aksel/togglegroup/valgt.js';
export * from './events/aksel/file-upload/fil-fjernet.js';
export * from './events/aksel/file-upload/fil-lastet-opp.js';
export * from './events/filtervalg/filtervalg.js';
export * from './events/aksel/formprogress/steg-vist.js';
export * from './events/aksel/formprogress/steg-klikket.js';
export * from './events/aksel/formsummary/vist.js';
export * from './events/aksel/formsummary/felt-redigert.js';
export * from './events/aksel/guidepanel/vist.js';
export * from './events/aksel/helptext/vist.js';
export * from './events/aksel/helptext/lukket.js';
export * from './events/aksel/button/knapp-klikket.js';
export * from './events/aksel/link/klikket.js';
export * from './events/aksel/link-card/klikket.js';
export * from './events/last-ned/last-ned.js';
export * from './events/aksel/pagination/side-valgt.js';
export * from './events/aksel/pagination/storrelse-endret.js';
export * from './events/aksel/popover/apnet.js';
export * from './events/aksel/popover/lukket.js';
export * from './events/aksel/read-more/apnet.js';
export * from './events/aksel/read-more/lukket.js';
export * from './events/aksel/modal/apnet.js';
export * from './events/aksel/modal/lukket.js';
export * from './events/aksel/monthpicker/maned-valgt.js';
export * from './events/navigere/navigere.js';
export * from './events/navigere/kopier-lenke.js';
export * from './events/navigere/chat-apnet.js';
export * from './events/navigere/ring-oss.js';
export * from './events/navigere/video-start.js';
export * from './events/navigere/video-stopp.js';
export * from './events/navigere/vis-flere-treff.js';
export * from './events/navigere/sok.js';
export * from './events/navigere/resultat-klikk.js';
export * from './events/aksel/select/nedtrekksliste-valg-endret.js';
export * from './events/aksel/radio/valg-endret.js';
export * from './events/aksel/table/sortering-endret.js';
export * from './events/aksel/table/rad-valgt.js';
export * from './events/aksel/table/filter-anvendt.js';
export * from './events/aksel/table/rad-utvidet.js';
export * from './events/aksel/stepper/steg-endret.js';
export * from './events/skjema/apnet.js';
export * from './events/skjema/fullfort.js';
export * from './events/skjema/innsending-feilet.js';
export * from './events/skjema/sporsmal-besvart.js';
export * from './events/skjema/startet.js';
export * from './events/skjema/steg-fullfort.js';
export * from './events/skjema/validering-feilet.js';
export * from './events/aksel/search/sok.js';
export * from './events/aksel/search/sokeforslag-valgt.js';
export * from './events/aksel/switch/tilstand-endret.js';
export * from './events/aksel/copy-button/tekst-kopiert.js';
export * from './events/aksel/tag/fjernet.js';
export * from './events/aksel/textarea/utfylt.js';
export * from './events/aksel/textfield/tekstfelt-utfylt.js';
export * from './events/aksel/tooltip/vist.js';
export * from './events/aksel/tooltip/lukket.js';
export * from './events/aksel/expansion-card/utvidbart-kort-apnet.js';
export * from './events/aksel/expansion-card/utvidbart-kort-lukket.js';

// Importerer hendelsesnavn for samlet objekt
import { ACCORDION_APNET_EVENT } from './events/aksel/accordion/apnet.js';
import { ACCORDION_LUKKET_EVENT } from './events/aksel/accordion/lukket.js';
import { ACTIONMENU_APNET_EVENT } from './events/aksel/actionmenu/apnet.js';
import { ACTIONMENU_LUKKET_EVENT } from './events/aksel/actionmenu/lukket.js';
import { ACTIONMENU_VALG_VALGT_EVENT } from './events/aksel/actionmenu/valg-valgt.js';
import { ACTIONMENU_UNDERMENY_APNET_EVENT } from './events/aksel/actionmenu/undermeny-apnet.js';
import { ACTIONMENU_UNDERMENY_LUKKET_EVENT } from './events/aksel/actionmenu/undermeny-lukket.js';
import { ALERT_LUKKET_EVENT } from './events/aksel/alert/lukket.js';
import { ALERT_VIST_EVENT } from './events/aksel/alert/vist.js';
import { GLOBALALERT_VIST_EVENT } from './events/aksel/globalalert/vist.js';
import { GLOBALALERT_LUKKET_EVENT } from './events/aksel/globalalert/lukket.js';
import { LOCALALERT_VIST_EVENT } from './events/aksel/localalert/vist.js';
import { LOCALALERT_LUKKET_EVENT } from './events/aksel/localalert/lukket.js';
import { INLINEMESSAGE_VIST_EVENT } from './events/aksel/inlinemessage/vist.js';
import { INFOCARD_VIST_EVENT } from './events/aksel/infocard/vist.js';
import { PROCESS_VIST_EVENT } from './events/aksel/process/vist.js';
import { PROCESS_STEG_KLIKKET_EVENT } from './events/aksel/process/steg-klikket.js';
import { AVKRYSNINGSBOKS_ENDRET_EVENT } from './events/aksel/checkbox/endret.js';
import { BESOK_EVENT } from './events/besok/besok.js';
import { CHIP_FJERNET_EVENT } from './events/aksel/chips/fjernet.js';
import { CHIP_TOGGLED_EVENT } from './events/aksel/chips/toggled.js';
import { COMBOBOX_OPTION_TOGGLED_EVENT } from './events/aksel/combobox/option-toggled.js';
import { DATO_VALGT_EVENT } from './events/aksel/datepicker/dato-valgt.js';
import { ERROR_SUMMARY_VIST_EVENT } from './events/aksel/errorsummary/vist.js';
import { ERROR_SUMMARY_FEILMELDING_KLIKKET_EVENT } from './events/aksel/errorsummary/feilmelding-klikket.js';
import { FANE_BYTTET_EVENT } from './events/aksel/tabs/fane-byttet.js';
import { TOGGLEGROUP_VALGT_EVENT } from './events/aksel/togglegroup/valgt.js';
import { FIL_FJERNET_EVENT } from './events/aksel/file-upload/fil-fjernet.js';
import { FIL_LASTET_OPP_EVENT } from './events/aksel/file-upload/fil-lastet-opp.js';
import { FILTERVALG_EVENT } from './events/filtervalg/filtervalg.js';
import { FORMPROGRESS_STEG_VIST_EVENT } from './events/aksel/formprogress/steg-vist.js';
import { FORMPROGRESS_STEG_KLIKKET_EVENT } from './events/aksel/formprogress/steg-klikket.js';
import { FORMSUMMARY_VIST_EVENT } from './events/aksel/formsummary/vist.js';
import { FORMSUMMARY_FELT_REDIGERT_EVENT } from './events/aksel/formsummary/felt-redigert.js';
import { GUIDEPANEL_VIST_EVENT } from './events/aksel/guidepanel/vist.js';
import { HELPTEXT_LUKKET_EVENT } from './events/aksel/helptext/lukket.js';
import { HELPTEXT_VIST_EVENT } from './events/aksel/helptext/vist.js';
import { KNAPP_KLIKKET_EVENT } from './events/aksel/button/knapp-klikket.js';
import { LINK_KLIKKET_EVENT } from './events/aksel/link/klikket.js';
import { LINKCARD_KLIKKET_EVENT } from './events/aksel/link-card/klikket.js';
import { LAST_NED_EVENT } from './events/last-ned/last-ned.js';
import { PAGINERING_SIDE_VALGT_EVENT } from './events/aksel/pagination/side-valgt.js';
import { PAGINERING_STORRELSE_ENDRET_EVENT } from './events/aksel/pagination/storrelse-endret.js';
import { POPOVER_APNET_EVENT } from './events/aksel/popover/apnet.js';
import { POPOVER_LUKKET_EVENT } from './events/aksel/popover/lukket.js';
import { LES_MER_APNET_EVENT } from './events/aksel/read-more/apnet.js';
import { LES_MER_LUKKET_EVENT } from './events/aksel/read-more/lukket.js';
import { MODAL_APNET_EVENT } from './events/aksel/modal/apnet.js';
import { MODAL_LUKKET_EVENT } from './events/aksel/modal/lukket.js';
import { MONTHPICKER_MANED_VALGT_EVENT } from './events/aksel/monthpicker/maned-valgt.js';
import { NAVIGERE_EVENT } from './events/navigere/navigere.js';
import { KOPIER_LENKE_EVENT } from './events/navigere/kopier-lenke.js';
import { CHAT_APNET_EVENT } from './events/navigere/chat-apnet.js';
import { RING_OSS_EVENT } from './events/navigere/ring-oss.js';
import { VIDEO_START_EVENT } from './events/navigere/video-start.js';
import { VIDEO_STOPP_EVENT } from './events/navigere/video-stopp.js';
import { VIS_FLERE_TREFF_EVENT } from './events/navigere/vis-flere-treff.js';
import { SOK_NAVNO_EVENT } from './events/navigere/sok.js';
import { RESULTAT_KLIKK_EVENT } from './events/navigere/resultat-klikk.js';
import { NEDTREKKSLISTE_VALG_ENDRET_EVENT } from './events/aksel/select/nedtrekksliste-valg-endret.js';
import { RADIO_VALG_ENDRET_EVENT } from './events/aksel/radio/valg-endret.js';
import { TABELL_RAD_VALGT_EVENT } from './events/aksel/table/rad-valgt.js';
import { TABELL_SORTERING_ENDRET_EVENT } from './events/aksel/table/sortering-endret.js';
import { TABELL_FILTER_ANVENDT_EVENT } from './events/aksel/table/filter-anvendt.js';
import { TABELL_RAD_UTVIDET_EVENT } from './events/aksel/table/rad-utvidet.js';
import { STEPPER_STEG_ENDRET_EVENT } from './events/aksel/stepper/steg-endret.js';
import { SKJEMA_APNET_EVENT } from './events/skjema/apnet.js';
import { SKJEMA_FULLFORT_EVENT } from './events/skjema/fullfort.js';
import { SKJEMA_INNSENDING_FEILET_EVENT } from './events/skjema/innsending-feilet.js';
import { SKJEMA_SPORSMAL_BESVART_EVENT } from './events/skjema/sporsmal-besvart.js';
import { SKJEMA_STARTET_EVENT } from './events/skjema/startet.js';
import { SKJEMA_STEG_FULLFORT_EVENT } from './events/skjema/steg-fullfort.js';
import { SKJEMA_VALIDERING_FEILET_EVENT } from './events/skjema/validering-feilet.js';
import { SOK_EVENT } from './events/aksel/search/sok.js';
import { SOKEFORSLAG_VALGT_EVENT } from './events/aksel/search/sokeforslag-valgt.js';
import { SWITCH_TILSTAND_ENDRET_EVENT } from './events/aksel/switch/tilstand-endret.js';
import { TAG_FJERNET_EVENT } from './events/aksel/tag/fjernet.js';
import { TEKST_KOPIERT_EVENT } from './events/aksel/copy-button/tekst-kopiert.js';
import { TEXTAREA_UTFYLT_EVENT } from './events/aksel/textarea/utfylt.js';
import { TEKSTFELT_UTFYLT_EVENT } from './events/aksel/textfield/tekstfelt-utfylt.js';
import { TOOLTIP_LUKKET_EVENT } from './events/aksel/tooltip/lukket.js';
import { TOOLTIP_VIST_EVENT } from './events/aksel/tooltip/vist.js';
import { UTVIDBART_KORT_APNET_EVENT } from './events/aksel/expansion-card/utvidbart-kort-apnet.js';
